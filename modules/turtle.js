/* TODO:
    ...
    [ ] Remove dependency on p5 somehow
*/

module.exports = (() => {
// TODO Jun 6: requires for dependencies, return for the class

let triangle = require('./triangle-factory'),
  path = require('./path-closure'),
  hud = require('./hud-closure')
...
return class Turtle {
  ...
  constructor (x = 0, y = 0) {
    ...
    this.triangle = triangle.create(15)

    this.path = path.create()
    this.path.addNode(this.position)

    this.hud = hud.create(this)
  }
